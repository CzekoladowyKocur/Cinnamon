...
namespace CinMath {
	...
	public:
		...
		friend Vector<4, ValueType> CIN_MATH_CALL operator+(const Vector<4, ValueType>& vector) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator-(const Vector<4, ValueType>& vector) noexcept;
		...
		friend Vector<4, ValueType> CIN_MATH_CALL operator+(const Vector<4, ValueType>& lhs, const Vector<4, ValueType>& rhs) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator-(const Vector<4, ValueType>& lhs, const Vector<4, ValueType>& rhs) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator*(const Vector<4, ValueType>& lhs, const Vector<4, ValueType>& rhs) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator/(const Vector<4, ValueType>& lhs, const Vector<4, ValueType>& rhs) noexcept;
		 
		friend Vector<4, ValueType> CIN_MATH_CALL operator+(const Vector<4, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator-(const Vector<4, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator*(const Vector<4, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Vector<4, ValueType> CIN_MATH_CALL operator/(const Vector<4, ValueType>& lhs, const ValueType scalar) noexcept;
		
		friend Vector<4, ValueType> CIN_MATH_CALL operator*(const Vector<4, ValueType>& lhs, const Matrix<4, 4, ValueType>& rhs) noexcept;
	public:
		union
		{
			struct
