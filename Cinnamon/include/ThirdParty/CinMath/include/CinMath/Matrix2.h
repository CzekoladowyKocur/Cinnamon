...
namespace CinMath {
	...
	public:
		...
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator+(const Matrix<2, 2, ValueType>& vector) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator-(const Matrix<2, 2, ValueType>& vector) noexcept;
		...
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator+(const Matrix<2, 2, ValueType>& lhs, const Matrix<2, 2, ValueType>& rhs) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator-(const Matrix<2, 2, ValueType>& lhs, const Matrix<2, 2, ValueType>& rhs) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator*(const Matrix<2, 2, ValueType>& lhs, const Matrix<2, 2, ValueType>& rhs) noexcept;

		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator+(const Matrix<2, 2, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator-(const Matrix<2, 2, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator*(const Matrix<2, 2, ValueType>& lhs, const ValueType scalar) noexcept;
		friend Matrix<2, 2, ValueType> CIN_MATH_CALL operator/(const Matrix<2, 2, ValueType>& lhs, const ValueType scalar) noexcept;
	public:
