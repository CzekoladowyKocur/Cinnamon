...
namespace Cinnamon {
	...
	inline void SetUITheme(ImGuiStyle& style, const EUITheme theme) noexcept
	{
		...
		switch (theme)
		{
			case EUITheme::Dark:
			{
				...
				colors[ImGuiCol_DockingPreview]			= ImVec4{ 204.0f / 255.0f, 164.0f / 255.0f, 61.0f / 255.0f, 1.0f };
				colors[ImGuiCol_NavHighlight]			= ImVec4{ 0.21f, 0.21f, 0.21f, 1.0f };
				colors[ImGuiCol_NavWindowingHighlight]	= ImVec4{ 0.21f, 0.21f, 0.21f, 1.0f };
				colors[ImGuiCol_NavWindowingDimBg]		= ImVec4{ 0.18f, 0.18f, 0.18f, 1.0f };
				colors[ImGuiCol_ModalWindowDimBg]		= ImVec4{ 0.08f, 0.08f, 0.08f, 0.1f };
